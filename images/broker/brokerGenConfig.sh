...
function create_config() {
    ...
    echo "#This file was generated by rocketmq-operator. DO NOT EDIT." >> $BROKER_CONFIG_FILE
    echo "brokerClusterName=DefaultCluster" >> $BROKER_CONFIG_FILE
    echo "namesrvAddr=$NAMESRV_ADDR" >> $BROKER_CONFIG_FILE
